...
The results above do not provide accuracy because we are attempting to predict a numeric variable and not a categorical one. Instead, we can look at the RMSE of 7.675412, which is very high pertaining to this scenario. This means, on average, our weighted error between actual and predicted is off by about 7. The R-Squared value is not a very favorable measure in determining the strength of our model because we are dealing with factors such as trends and non-stationary values that grow over time.
...
Source: Investopedia. "Moving Average Convergence Divergence (MACD)." [**https://www.investopedia.com/terms/m/macd.asp**](https://www.investopedia.com/terms/m/macd.asp)

2.  RSI Calculation:

Source: Investopedia. "Relative Strength Index - RSI." [**https://www.investopedia.com/terms/r/rsi.asp**](https://www.investopedia.com/terms/r/rsi.asp)

3.  SMA Calculation:

Source: Investopedia. "Simple Moving Average (SMA)." [**https://www.investopedia.com/terms/s/sma.asp**](https://www.investopedia.com/terms/s/sma.asp)

4.  EMA Calculation:

Source: Investopedia. "Exponential Moving Average (EMA)." [**https://www.investopedia.com/terms/e/ema.asp**](https://www.investopedia.com/terms/e/ema.asp)
